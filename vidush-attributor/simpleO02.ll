...
define dso_local { i32, ptr } @foo(i32 noundef %val) #0 {
entry:
  ...
  %field3 = getelementptr inbounds %struct.Foo, ptr %retval, i32 0, i32 1
...
entry:
  ...
  %call = call { i32, ptr } @foo(i32 noundef %0)
  %1 = getelementptr inbounds { i32, ptr }, ptr %ff, i32 0, i32 0
  %2 = extractvalue { i32, ptr } %call, 0
  store i32 %2, ptr %1, align 8
  %3 = getelementptr inbounds { i32, ptr }, ptr %ff, i32 0, i32 1
